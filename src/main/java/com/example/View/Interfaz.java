...
public class Interfaz {
    ...
    public void iniciar() {
        ...
        // Preguntar si quiere crear mas monstruos
        String respuesta = "S";
        ...
        // 5. Crear minimo 2 magos con minimo 2 hechizos cada uno
        System.out.println("\n--- CREACION DE MAGOS ---");
        ...
        // Preguntar si quiere crear mas magos
        respuesta = "S";
        while (respuesta.equals("S")) {
    ...
    private void crearBosque() {
        ...
        System.out.println("Bosque '" + bosque.getNombre() + "' creado con nivel de peligro " + bosque.getnivelPeligro());
    }
    ...
    private void asignarMonstruoJefe() {
        ...
        for (int i = 0; i < monstruosVivos.size(); i++) {
            ...
            System.out.println((i + 1) + ". " + m.getNombre() + " - Tipo: " + m.geTipo() + ", Vida: " + m.getVida() + ", Fuerza: " + m.getFuerza());
        }
    ...
    private void turnoMagos() {
        ...
        for (Mago mago : new ArrayList<>(magosVivos)) {
            ...
            if (monstruoObjetivo.getVida() <= 0) {
                ...
                if (bosque.getMonstruoJefe() != null && bosque.getMonstruoJefe().getId() == monstruoObjetivo.getId()) {
                    asignarNuevoJefe();
                }
            } else {
    ...
    private void mostrarEstado() {
        ...
        if (bosque.getMonstruoJefe() != null) {
            Monstruo jefe = bosque.getMonstruoJefe();
            System.out.println("- " + jefe.getNombre() + " (Tipo: " + jefe.geTipo() + ", Vida: " + jefe.getVida() + ", Fuerza: " + jefe.getFuerza() + ")");
        } else {
        ...
        if (magosVivos.isEmpty()) {
            ...
            for (Mago mago : magosVivos) {
                System.out.println("- " + mago.getNombre() + " (Vida: " + mago.getVida() + ", Nivel de magia: " + mago.getNivelMagia() + ")");
            }
        }
        ...
        if (monstruosVivos.isEmpty()) {
            ...
            for (Monstruo monstruo : monstruosVivos) {
                System.out.println("- " + monstruo.getNombre() + " (Tipo: " + monstruo.geTipo() + ", Vida: " + monstruo.getVida() + ", Fuerza: " + monstruo.getFuerza() + ")");
            }
        }
        ...
        System.out.println("\nDRAGON:");
        if (dragon.getResistencia() > 0) {
            System.out.println("- " + dragon.getNombre() + " (Resistencia: " + dragon.getResistencia() + ", Intensidad de fuego: " + dragon.getIntensidadFuego() + ")");
        } else {
